...
<script>
var xmlhttp ;
var url = "http://finlife.fss.or.kr/finlifeapi/mortgageLoanProductsSearch.json?auth=ca671628ffa24c972229e54f6db94508&topFinGrpNo=020000&pageNo=1";
//페이지 번호 클릭
var goPage = function(pageNum) { 
	url = "http://finlife.fss.or.kr/finlifeapi/mortgageLoanProductsSearch.json?auth=ca671628ffa24c972229e54f6db94508&topFinGrpNo=020000&pageNo=1"+pageNum;
	startRequest();
}
