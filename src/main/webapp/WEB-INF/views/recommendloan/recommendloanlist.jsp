				...
				<table class="tableBox" >
					...
					<c:forEach var="vo" items="${volist}" varStatus="status">
						<tr>
							...
							<td><a href="recommendloandt?rlnum=${vo.RL_NUM}" style="color: black;"><font size="5px">${vo.KOR_CO_NM}</font></a></td>
							<td><a href="recommendloandt?rlnum=${vo.RL_NUM}" style="color: black;"><font size="5px">${vo.FIN_PRDT_NM }</font></a></td>
							<td><a href="recommendloandt?rlnum=${vo.RL_NUM}" style="color: black;"><font size="5px">${vo.LEND_RATE_TYPE_NM }</font></a></td>
						</tr>
					</c:forEach>
				</table>
			</div>
