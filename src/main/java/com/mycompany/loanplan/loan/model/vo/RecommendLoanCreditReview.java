...
@Component
public class RecommendLoanCreditReview implements java.io.Serializable {
	...
	public RecommendLoanCreditReview() {}
	
	public RecommendLoanCreditReview(int RLR_NUM, int RLR_AST, String RLR_COMMENT, int RL_CR_NUM, String M_ID) {
		super();
		this.RLR_NUM = RLR_NUM;
		this.RLR_AST = RLR_AST;
		this.RLR_COMMENT = RLR_COMMENT;
		this.RL_CR_NUM = RL_CR_NUM;
		this.M_ID = M_ID;
	}
