...
public class LoanCreditListTestController {
	...
	@Test
	public void testRecommendLoanCreditList() throws Exception {
		this.mmvc.perform(get("/recommendloan/recommendloancreditlist").param("page", "1"))
