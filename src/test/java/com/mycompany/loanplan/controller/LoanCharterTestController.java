...
public class LoanCharterTestController {
	...
	@Test
	public void testRecommendLoanCharterdt() throws Exception {
		
		this.mmvc.perform(get("/recommendloan/recommendloancharterdt").param("rlchnum", "1"))
		.andExpect(status().isOk())
		.andExpect(view().name("recommendloan/recommendloancharterdt"));
	}
